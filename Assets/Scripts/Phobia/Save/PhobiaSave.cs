	...
	public abstract class PhobiaSaveBase<T> where T : class, new()
	{
		...
		public class PhobiaSave : PhobiaSaveBase<PhobiaSave.SaveData>
		{
			...
			public class PlayerData
			{
				...
				public void RemoveFavoriteLevel(string levelId)
				{
					favoriteLevels.Remove(levelId);
				}

				public bool IsFavoriteLevel(string levelId)
				{
					return favoriteLevels.Contains(levelId);
				}
